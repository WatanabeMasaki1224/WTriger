...
public class RedBulletWepon : SubWeponBase
{
    [Header("参考")]
    [SerializeField] protected Transform _firePoint;
    [SerializeField] protected Transform _cameraTransform;
    [SerializeField] protected GameObject _bigCubePrefab;
    [SerializeField] protected AsteroidProjectile _redBulletPrefab;
    [Header("ステータス")]
    ...
    /// アステロイドの弾を生成する
    /// </summary>
    protected  void CreateProjectile(Vector3 spawnPosition)
    {
        // ロックオン対象を取得
